...
./mtr --nocheck-testcase --mem --suite=histogram_plugin --record execute_timing --testcase-timeout=30000 --suite-timeout=30000 --mysqld=--plugin_dir=/export/home/tmp/bygging/plugin_output_directory/ --mysqld=--join-buffer-size=104857600 --mysqld=--read-buffer-size=104857600 --mysqld=--sort-buffer-size=104857600 --mysqld=--query-prealloc-size=104857600 --mysqld=--key-buffer-size=1073741824 --mysqld=--innodb-buffer-pool-size=6G --mysqld=--disable_log_bin --mysqld=--autocommit=0 #--mysqld=--innodb-buffer-pool-instances=16
